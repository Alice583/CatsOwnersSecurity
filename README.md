(Лабораторная работа 4 четвертого семестра ИТМО)
...
Дополнительно:  
 Должна быть реализована возможность получения пользовательской сессии непосредственно через Swagger UI.   
 **При наличии миграций, необходимо добавить создание учётной записи администратора с паролем по-умолчанию.**
